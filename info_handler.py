...
async def info_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    info_texts = {
        "prices": (
            ...
            "────── ✦ ──────\n"
            "👧 *Для детских групп*\n\n"
            "🔹 Пробное занятие — 150.000₫\n"
            "🔹 Разовое занятие — 300.000₫\n"
            "🔹 Тестовый абонемент на 3 занятия — 600.000₫ (_Только для новичков_)\n\n"
            "❗️*Обязательна предварительная запись*❗️\n\n"
            "❗️Пробные и разовые посещения возможны только при наличии мест в группе.\n\n"
            "ℹ️ Для взрослой группы действуют отдельные цены — выберите группу ниже."
        ),
        "schedule": (
        ...
        "abonement": (
            ...
            " 🔸 Пробные и разовые посещения возможны только по предварительной записи и при наличии мест\n"
            " 🔸 Количество мест в группе ограничено\n"
            " 🔸 Оплата следующего абонемента производится до окончания текущего, чтобы сохранить место\n"
            " 🔸 Возврат средств за оплаченные тренировки не производится, кроме форс-мажорных обстоятельств (по договорённости)\n"
            " 🔸 Регулярные занятия напрямую влияют на прогресс, дисциплину и уверенность ребёнка\n"
            "────── ✦ ──────\n\n"
            ...
            "⏸️ *Пропуски, переносы и заморозка:*\n\n"
            " 🔺 Переносы занятий не предусмотрены\n"
            " 🔺 Пропуски по болезни не компенсируются\n"
            " 🔺 В исключительных случаях возможен индивидуальный разбор ситуации\n\n"
            " 🔺 Возможна разовая заморозка абонемента\n"
            "   (серьёзные травмы, длительные отъезды)\n"
            "   по предварительной договорённости, *не более 7 дней*\n\n"
        
            "📌 В течение 35 дней можно гибко распределять занятия\n"
            "в рамках закреплённого расписания\n\n"
        
            "📌 Если тренировка отменяется по инициативе тренера,\n"
            "срок абонемента автоматически продлевается\n"
        
            "────── ✦ ──────\n\n"
        
            "⚠️ В случае систематического нарушения дисциплины\n"
            "тренер оставляет за собой право приостановить посещение занятий без возврата средств\n\n"
        ...
        "group_4_5": (
            ...
            "🔸 *Абонемент на 5 занятий* — 1.250.000₫\n"
            "   (подходит, если ребёнок только начинает или посещает нерегулярно)\n\n"
            "🔸 *Безлимитный абонемент* — 1.600.000₫\n"
            ...
            "Подробнее — в разделе *Правила абонементов* ⬇️"
        ),
        "group_6_9": (
            "🤸 *Группы 6–9 лет*\n"
            "────── ✦ ──────\n"
            ...
            "🔸 *Абонемент на 5 занятий* — 1.250.000₫\n"
            "   (подходит, если ребёнок только начинает или посещает нерегулярно)\n\n"
            "🔸 *Абонемент на 8 занятий* — 1.600.000₫\n"
            "   (подходит, если ребёнок ходит от 2 раз в неделю)\n\n"
            "🔸 *Безлимитный абонемент* — 2.250.000₫\n"
            "   Подходит для регулярных тренировок и стабильного прогресса.\n\n"
            "ℹ️ Пробное, разовое и тестовый абонемент на 3 занятия смотрите в разделе *Цены и абонементы*.\n\n"
            "⏳ Абонементы действуют *35 дней* и не предусматривают переносов.\n"
            "Подробнее — в разделе *Правила абонементов* ⬇️"
        ),
        "group_adults": (
            ...
            "Количество мест в группе — 6 человек.\n\n"
             "────── ✦ ──────\n"
            "🗓 *Расписание:*\n\n"
            "Вт / Чт — 10:00–11:30\n\n"
            "────── ✦ ──────\n"
            "💳 *Доступные форматы занятий:*\n\n"
            "🔸 *Пробное занятие* — 200.000₫\n\n"
            "🔸 *Разовое занятие* — 400.000₫\n\n"
            "🔸 *Пробный абонемент на 3 занятия* — 900.000₫ (_только для новичков_)\n\n"
            "🔸 *Абонемент на 5 занятий* — 1.900.000₫\n"
            "   (подходит, если только начинаете или планируете посещать тренировки нерегулярно)\n\n"
            "🔸 *Безлимитный абонемент* — 2.400.000₫\n"
            "   (подходит для регулярных тренировок и стабильного прогресса)\n\n"
            "⏳ Абонементы действуют *35 дней* и не предусматривают переносов.\n"
            "Подробнее — в разделе *Правила абонементов* ⬇️"
        )
