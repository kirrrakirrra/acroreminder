...
async def info_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    info_texts = {
        "prices": (
            ...
            "▫️ Тестовый абонемент на 3 занятия — 600.000₫ (_Только для новичков_)\n\n"
        ...
        "group_4_5": (
            ...
            "▫️ 5️⃣*Абонемент на 5 занятий* — 1.250.000₫\n"
            "   Подходит для посещения около 1 раза в неделю.\n\n"
            "▫️ ♾️*Безлимитный абонемент* — 1.600.000₫\n"
        ...
        "group_6_9": (
            ...
            "▫️ 5️⃣*Абонемент на 5 занятий* — 1.250.000₫\n"
            "   Подходит для посещения около 1 раза в неделю.\n\n"
            "▫️ 8️⃣*Абонемент на 8 занятий* — 1.600.000₫\n"
            "   Подходит для посещения 2 раза в неделю.\n\n"
            "▫️ ♾️*Безлимитный абонемент* — 2.250.000₫\n"
